    ...
    <div id="top">
        <div class="container">
            <div class="col-md-6 offer" data-animate="fadeInDown">
                <a href="#" class="btn btn-success btn-sm" data-animate-hover="shake"> Bienvenue </a>  <a href="#">chez BTS !</a>
            </div>
            ...
            <div class="navbar-collapse collapse" id="navigation">
                ...
                <ul class="nav navbar-nav navbar-left">
                    ...
                    <li class="dropdown yamm-fw">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown" data-delay="200">Bureautique <b class="caret"></b></a>
                    ...
                    <li class="dropdown yamm-fw">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown" data-delay="200">Informatique <b class="caret"></b></a>
                        <ul class="dropdown-menu">
                            <li>
                                <div class="yamm-content">
                                    <div class="row">
                    ...
                    <li class="dropdown yamm-fw">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown" data-delay="200">Imprimerie <b class="caret"></b></a>
                        <ul class="dropdown-menu">
                            <li>
                                <div class="yamm-content">
                                    <div class="row">
                    ...
                    <!-- modifications SAV -->
                   <li class="dropdown yamm-fw">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown" data-delay="200">Autre<b class="caret"></b></a>
                        <ul class="dropdown-menu">
                            <li>
                                <div class="yamm-content">
                                    <div class="row">
                                        <div class="col-sm-3">
                                            ...
                                            <ul>
                                                <li><a href="category.html">Réparation</a>
                                                </li>
                                                <li><a href="category.html">Rendez-vous</a>
                                                </li>
                                            </ul>
                                        </div>
                                        <div class="col-sm-3">
                                        ...
                                        <div class="col-sm-3">
                                            <h5>Réclamations</h5>
                                            <ul>
                                                <li><a href="category.html">Envoyer une Reclamation</a>
                                                </li>
                                            </ul>
                                        </div>
                   ...
                   <li>
                                       <li><a href="actualite.html">Actualite</a>
                    </li>
                   </li> 
                </ul>
...
//include_once "config.php";
 include_once "../fadfoud/core/formc.php";
