...
<nav class="navbar navbar-expand-md bg-dark navbar-dark">
  ...
  <div class="container-fluid">
    <div class="row justify-content-center">
      <div class="col-md-10">
        <h3 class="text-center text-dark mt-2">Epace Admin Livreur</h3>
        <hr>
    ...
    <div class="row">
      <div class="col-md-4">
        ...
        <form action="action.php" method="post" enctype="multipart/form-data">
          ...
          <div class="form-group">
            <input type="tel" name="phone" minlength="8" maxlength="8" value="<?= $phone; ?>" class="form-control" placeholder="Enter phone" required>
          </div>
          <div class="form-group">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td>
                ...
                <a href="index7.php?edit=<?= $row['id']; ?>" class="badge badge-success p-2">Edit</a>
              </td>
            </tr>
            <?php } ?>
          </tbody>
  ...
  <footer> <br><br> <br><br><br><br><br> <br> <br><p>sportnews TEAM &copy;</p></footer>
